  ...
  <div>
    ...
    <div>
      ...
      <el-form :inline="true">
        <!-- 分类查询 -->
        <el-form-item>
          <el-select v-model="queryInfo.tid">
            <el-option v-for="a in types" :key="a.tid" :value="a.tid" :label="a.typeName">
              <span style="float: left">{{ a.typeName }}</span>
            </el-option>
          </el-select>
        </el-form-item>
    ...
    <div>
      <el-dialog title="进货" :visible.sync="imodbisible" :close-on-click-modal="false" @closed="query">
        <div v-loading="loading">
          <el-form>
            <el-form-item> {{ imodInfo.goodsName }}进货信息录入: </el-form-item>
            <el-form-item>
